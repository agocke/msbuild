...
namespace Microsoft.Build.CommandLine.Experimental
{
    ...
    internal sealed class CommandLineSwitches
    {
        ...
        private static readonly ParameterizedSwitchInfo[] s_parameterizedSwitchesMap =
        {
            ...
            new ParameterizedSwitchInfo(  ["evaluationmode"],                  ParameterizedSwitch.EvaluationMode,              "DuplicateEvaluationModeSwitchError", false,          "MissingEvaluationModeParameterError", true,   false,   "HelpMessage_EvaluationModeSwitch"),
