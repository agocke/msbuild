...
namespace Microsoft.Build.BackEnd
{
    ...
    internal class PropertyGroupIntrinsicTask : IntrinsicTask
    {
        ...
        internal static void Execute(
            ProjectPropertyGroupTaskInstance taskInstance,
        ...
        private readonly struct Executor
        {
            ...
            {
                foreach (ProjectPropertyGroupTaskPropertyInstance property in
                    _taskInstance.Properties)
                {
            ...
            private static void GetBatchableValuesFromProperty(List<string> parameterValues, ProjectPropertyGroupTaskPropertyInstance property)
            {
                IntrinsicTask.AddIfNotEmptyString(parameterValues, property.Value);
                IntrinsicTask.AddIfNotEmptyString(parameterValues, property.Condition);
            }
        }
    }
}
